...
const projects = {
  tamos: {
    title: 'TAMOS UHV Heat Chamber',
    tag: 'UHV Systems · Vacuum',
    desc: 'Engineered a UHV Heat Chamber to bake a quantum ion trapping system — built from scratch and operated at ±1.5% uniformity at 200ºC under 1kW.',
  ...
  fsae: {
    ...
    desc: 'Founding aero lead. Spearheaded the first complete CAD model Rice FSAE\'s aerodynamic package, including a nosecone, undertray with a diffuser, side pods, and bodywork.',
